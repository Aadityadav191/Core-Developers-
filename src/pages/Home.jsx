...
import { 
   ChevronRight,Globe, ShieldCheck, Database,Terminal, Cpu
} from 'lucide-react';
    ...
    <div className="bg-[#031c36] text-white font-sans selection:bg-[#de8f32] selection:text-[#031c36]">
     ...
     <section className="relative min-h-screen flex items-center justify-center  pb-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 backdrop-blur-md">
            ...
            >
              Architecting secure, highly-scalable ecosystem environments designed to drive modern business metrics and massive digital market advantages.
            </motion.p>
              ...
              <div className="p-6 h-full flex flex-col justify-between font-mono text-xs text-slate-400">
                <div className="space-y-4">
                  <div className="flex gap-1.5 border-b border-white/5 pb-4">
                    ...
                    <span className="text-[10px] text-slate-500 ml-2">core-engine.config.ts</span>
                  </div>
                  <div className="space-y-1.5 text-sky-400/90">
                    <p><span className="text-indigo-400">import</span> &#123; Cluster &#125; <span className="text-indigo-400">from</span> <span className="text-amber-300">"core-systems"</span>;</p>
                    <p className="text-slate-500">// Initialize distributed network ecosystems</p>
                    <p><span className="text-indigo-400">const</span> app = <span className="text-emerald-400">new</span> <span className="text-amber-200">Cluster</span>(&#123;</p>
                    <p className="pl-4">scaling: <span className="text-amber-400">"auto-elastic"</span>,</p>
                    <p className="pl-4">redundancy: <span className="text-amber-400">"multi-region"</span>,</p>
                ...
                <div className="grid grid-cols-2 gap-3 pt-6 border-t border-white/5">
                  <div className="flex items-center gap-3 p-3 rounded-xl bg-white/2 border border-white/5">
                    ...
                    <div className="font-sans text-left">
                      <p className="font-semibold text-white text-xs">Web Engines</p>
                      <p className="text-[10px] text-slate-500">React & Next.js</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 rounded-xl bg-white/2 border border-white/5">
                    <Cpu size={18} className="text-sky-400" />
                    <div className="font-sans text-left">
                      <p className="font-semibold text-white text-xs">Scalable Cloud</p>
                      <p className="text-[10px] text-slate-500">Go & Microservices</p>
                    </div>
                  </div>
                </div>
              </div>
