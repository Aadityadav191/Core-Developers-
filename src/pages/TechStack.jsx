...
const TechStack = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Core Developers - Tech Stack</title>
        <meta
          name="description"
          content="Explore the core technologies and tools that power our development process. From frontend frameworks to backend solutions, we leverage the best in class technologies."
        />
      </Helmet>
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="text-center mb-24">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              We don't chase every trend. We master the tools that offer the
              best balance of speed, security, and scalability for our clients.
            </p>
          </div>
            ...
            <div className="bg-[#031c36] rounded-[2.9rem] p-10 flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="text-left">
                ...
                <p className="text-gray-400">
                  Our senior architects are experts in polyglot programming.
                </p>
              </div>
