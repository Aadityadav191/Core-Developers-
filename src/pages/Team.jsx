      ...
      <div className="min-h-screen bg-[#031c36] text-white pt-20 pb-20 px-6 selection:bg-[#de8f32] selection:text-[#031c36] overflow-x-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="text-center mb-15">
            ...
            >
              Meet the{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#015aae] to-cyan-400">
                Core
              </span>{" "}
              Team
            </motion.h1>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed">
              A specialized collective of engineers and designers operating at
              the bleeding edge of digital performance.
            </p>
          </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-4 pt-5 border-t border-white/10">
                      <a
                        ...
                        className="text-gray-500 hover:text-[#015aae] transition-all transform hover:-translate-y-1"
                      >
                        <FaLinkedin />
                      </a>
                      <a
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-4xl font-black mb-6 leading-tight">
                  Our Collective <br />
                  <span className="text-[#de8f32]">Technical Arsenal</span>
                </h2>
                <p className="text-gray-400 mb-8">
                  We don't just use tools; we master ecosystems. Our team spends
                  20% of their time researching emerging technologies to ensure
                  your project stays ahead of the curve.
                </p>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    <div
                      key={idx}
                      className="flex items-center gap-3 p-4 rounded-xl bg-white/5 border border-white/5 hover:border-[#015aae]/50 transition-colors"
                    >
              ...
              <div className="relative">
                <div className="aspect-video rounded-[2rem] bg-gradient-to-br from-[#015aae]/20 to-transparent border border-white/10 flex items-center justify-center overflow-hidden">
                  ...
                  <div className="text-center p-8">
                    <p className="text-6xl font-black text-white/10 mb-2">
                      124k+
                    </p>
                    <p className="text-[#de8f32] font-bold text-xs uppercase tracking-[0.3em]">
                      Commits in 2025
                    </p>
                  </div>
                </div>
          ...
          <div className="relative p-12 md:p-20 rounded-[3.5rem] bg-white/[0.02] border border-white/10 overflow-hidden text-center">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-4xl md:text-5xl font-black mb-6">
                Want to join the <span className="text-[#015aae]">Core</span>?
              </h2>
              <p className="text-gray-400 max-w-xl mx-auto mb-10">
                We’re always looking for obsessed engineers and pixel-perfect
                designers. If you live and breathe code, we want to hear from
                you.
              </p>
              <Link
                to="/career"
                className="px-10 py-4 bg-white text-[#031c36] font-black rounded-2xl hover:bg-[#de8f32] transition-all duration-300 hover:scale-105"
              >
                VIEW OPEN ROLES
              </Link>
            </div>
