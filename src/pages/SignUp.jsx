        ...
        <div className="hidden lg:flex flex-col justify-center p-12 bg-gradient-to-br from-[#015aae] to-[#031c36] relative overflow-hidden">
          ...
          >
            ...
            <h2 className="text-4xl font-bold text-white leading-tight mb-4">
              Begin your <span className="text-[#de8f32]">Digital </span> journey.
            </h2>
            <p className="text-blue-100/60 leading-relaxed text-sm mb-8">
              Create an account to join our ecosystem. Experience seamless project management, rapid deployments, and elite technical support.
            </p>
        ...
        <div className="p-10 lg:p-16 flex flex-col justify-center">
          <div className="mb-10 text-center lg:text-left">
            ...
            <p className="text-gray-400 text-sm">
              Already have an account? <NavLink to="/auth/login" className="text-[#de8f32] hover:underline font-semibold">Sign in</NavLink>
            </p>
          </div>
          ...
          <form className="space-y-4">
            ...
            {/* Password Input */}
            <div className="group space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-500 ml-1">Create Password</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-500 group-focus-within:text-[#de8f32] transition-colors">
                  <Lock size={18} />
                </div>
            ...
            <div className="flex items-center gap-3 px-1 py-2">
              <input type="checkbox" className="w-4 h-4 rounded border-white/10 bg-white/5 checked:bg-[#de8f32] focus:ring-0 transition-all cursor-pointer" />
              <label className="text-[10px] text-gray-500 font-medium">
                I agree to the <span className="text-[#de8f32] cursor-pointer">Terms of Service</span> and <span className="text-[#de8f32] cursor-pointer">Privacy Policy</span>.
              </label>
            </div>
            ...
            <div className="flex items-center gap-4 my-6">
              ...
              <span className="text-[10px] text-gray-600 font-bold uppercase tracking-widest">or register with</span>
              <div className="h-px bg-white/5 flex-1"></div>
            </div>
